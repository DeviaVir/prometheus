...
You will need to use `promtool` from [Prometheus 2.5](https://github.com/DeviaVir/prometheus/v2/releases/tag/v2.5.0) as later versions no longer contain the above subcommand.
...
See [issue #3060](https://github.com/DeviaVir/prometheus/v2/issues/3060) for more
details.
...
as a non-root user](https://github.com/DeviaVir/prometheus/v2/pull/2859). If you
