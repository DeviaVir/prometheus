...
// This test exposes https://github.com/prometheus/prometheus/v2/issues/7412 where the truncation
...
// https://github.com/prometheus/prometheus/v2/issues/7753
func TestHeadReadWriter_TruncateAfterFailedIterateChunks(t *testing.T) {
	...
	// Restarting to recreate https://github.com/prometheus/prometheus/v2/issues/7753.
	hrw, err = NewChunkDiskMapper(dir, chunkenc.NewPool(), DefaultWriteBufferSize)
	require.NoError(t, err)
